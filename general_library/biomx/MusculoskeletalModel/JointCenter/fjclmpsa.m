function [c2,cost] = fjclmpsa(r1,r2,p1,m2,c2init,c2lb,c2ub,maxiter)
%
%   functional joint center estimator: least moving point, Marin et al.
%   2003, Ehrig 07, simulated annealing
%
...
%
%   maxiter:
%       MaxIterations argument in simulanneal() function
%
%---------------------------------OUTPUTS----------------------------------
%
%   c2:
...
% simulated annealing
options = optimoptions('simulannealbnd','MaxIterations',maxiter,'Display','iter');
[c2,cost] = simulannealbnd(@objfun,c2init,c2lb,c2ub,options);
