...
% null mediolateral translation
z = zeros(1,length(f));

% offset s.t. [xnew,ynew] = [x,y] - [xoffset,yoffset]. Offsets were
% determined by interp1(u,v,0,'pchip') using the appropriate u and v
x = x + 0.004369752584582;
y = y + 0.395695161187387;
